  ...
  public MsgAndListDto<Customer> addOrUpdateCustomer(final Customer customer) {
    ...
    if (customerId == null) {
      message = ConstantsAdminENG.NEW_CUSTOMER_WAS_NOT_CREATED
          + email + ConstantsAdminENG.CUSTOMER_NAME_ALREADY_EXIST_IN_DB;
      ...
      final MsgAndListDto<Customer> customerMsgAndListDtoByEmail =
          checkIfUserAlreadyExistInDbByEmail(customersByEmail, message);
